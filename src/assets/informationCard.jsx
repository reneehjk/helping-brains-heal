...
const InfoCard = ({ clinicName, location, details, imageSrc }) => {
    return (
        <div className="relative w-full h-[387px] rounded-xl overflow-hidden">
            ...
            <div className="mt-[23px] mx-4 h-full overflow-hidden">
            ...
            <div className="absolute bottom-0 left-1/2 transform -translate-x-1/2">
                <ButtonLink label="Learn More" width="py-2 px-4" />
            </div>
        </div>
    );
};
